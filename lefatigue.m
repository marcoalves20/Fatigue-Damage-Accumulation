function [ leF, deltaA,lintact,gammath,lcontrol,lecrit,vcrackprop] = lefatigue( tau0, gamma0, Sinf, dSL, T, tm,  GIIth, GIIctm, G, gammaN, C1, m, lambda,  DeltaN, N, R, Lout,C,Ef,level,rf,A )
